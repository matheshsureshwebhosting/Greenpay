...
router.patch("/status", async (req, res) => {
    ...
    const myquery = "SELECT * FROM pan_certificates WHERE iscomplete=? ORDER BY date DESC"
    const singleUser = new Promise(async (resolve, reject) => {
...
router.get("/single/:userid", async (req, res) => {
    ...
    const myquery = "SELECT * FROM pan_certificates WHERE userid=? ORDER BY date DESC"
    const singleUser = new Promise(async (resolve, reject) => {
